...
* Cuando hacemos "git status", nos muestra que tenemos nuevos archivos por subir, pero que aún no me hemos hecho nada con ellos, cuando hacemos el "git add ." ó "git add NombreDelArchivo", el archivo se prepara para realizar un push. 